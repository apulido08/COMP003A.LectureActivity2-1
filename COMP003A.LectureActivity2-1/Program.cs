...
namespace COMP003A.LectureActivity2_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Are you 18 or older? {isAdult}"); // Display uf the user is 18 or older
            Console.WriteLine($"Are you both a student and 18 or older? {isAdultStudent}"); // Disdplay if the user is both a student and an adult
